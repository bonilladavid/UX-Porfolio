...
function TimelineItem({year, title, duration, details}) {
  return (
    ...
    relative border-l border-stone-200 dark:border-stone-700'>
        <li className='md-10 ml-4'>
            <div className='absolute w-3 h-3
            bg-stone-200 rounded-full mt-1.5 -left-1.5 
            border border-white dark:border-stone-900 dark:bg-stone-700'/>
                <p className='flex flex-wrap gap-4 
                flex-row items-center justify-start text-xs 
                md:text-sm'>
